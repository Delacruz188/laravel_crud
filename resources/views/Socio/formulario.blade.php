        ...
        <form enctype="multipart/form-data" action="{{action('SocioController@save')}}" class="form-horizontal" style='padding-top:20px' method="post">
          {{csrf_field()}}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="nombre_socio" :value="nombre">
                </div>
            </div>
            <div class="form-group" style="padding-top:10px">
                  <label for="curp" class="col-sm-2 control-label">Tipo de socio que desea</label>
                <div class="col-sm-10">
                  <input type="text" placeholder="(Basico: 1. Premium: 2. VIP: 3)" class="form-control" name="curp" :value="curp">
                </div>
            </div>
            <div class="form-group" style="padding-top:10px">
              <div class="col-sm-10">
